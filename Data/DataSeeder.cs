        ...
        public static async Task SeedAsync(IServiceProvider services)
        {
            ...
            try
            {
                ...
                var giaoDiens = new List<GiaoDien>
                {
                    ...
                    new GiaoDien { TenGiaoDien = "Logo phụ", LoaiGiaoDien = 1, MoTa = "Logo nhỏ cho footer", MetaTitle = "Secondary Logo", MetaDescription = "Logo phụ của thương hiệu", MetaKeywords = "logo, secondary", NgayTao = DateTime.UtcNow, TrangThai = 1 },
                    ...
                    new GiaoDien { TenGiaoDien = "Logo mobile", LoaiGiaoDien = 1, MoTa = "Logo dành cho mobile", MetaTitle = "Mobile Logo", MetaDescription = "Logo responsive cho mobile", MetaKeywords = "logo, mobile", NgayTao = DateTime.UtcNow, TrangThai = 1 },
                    ...
                    new GiaoDien { TenGiaoDien = "Logo favicon", LoaiGiaoDien = 1, MoTa = "Icon favicon", MetaTitle = "Favicon", MetaDescription = "Icon trang web", MetaKeywords = "favicon, icon", NgayTao = DateTime.UtcNow, TrangThai = 1 },
