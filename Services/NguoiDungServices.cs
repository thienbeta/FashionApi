        ...
        public async Task SendForgotPasswordOtpAsync(string email)
        {
            ...
            try
            {
                ...
                <body>
                    <div class='container'>
                        <div class='header'>
                            <img src='https://example.com/fashionapi-logo.png' alt='FashionApi Logo'>
                            <h2>Xin chào từ FashionApi!</h2>
                        </div>
                        <div class='content'>
                            ...
                            <a href='https://fashionapi.com/reset-password' class='button'>Đặt lại mật khẩu ngay</a>
                        </div>
                        <div class='footer'>
                            <p>&copy; 2025 FashionApi. Tất cả quyền được bảo lưu.</p>
                            <p>Liên hệ với chúng tôi: <a href='mailto:support@fashionapi.com'>support@fashionapi.com</a></p>
                            <p>Theo dõi chúng tôi: 
                                <a href='https://facebook.com/fashionapi'>Facebook</a> | 
                                <a href='https://instagram.com/fashionapi'>Instagram</a>
                            </p>
                        </div>
                    </div>
                </body>
